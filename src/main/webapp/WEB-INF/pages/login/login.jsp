...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<c:url value='/static/css/plugins/simple-line-icons.css' />">
			...
			<form class="form-signin" action="${home}/login" method="post">
				<div class="panel ">
					<div class="panel-body text-center">
						...
						<p class="atomic-mass"><fmt:formatDate pattern="dd/MM/yyyy" value="${now}" /></p>
						<p class="element-name">Quản Lý Trạm Xăng</p>
						<i class="icons icon-arrow-down"></i>

						<div class="form-group form-animate-text">
							<input type="text" id="username" name="username" class="form-text" required />
							<span class="bar"></span>
						...
						<label class="pull-left">
							<input type="checkbox" id="remember" name="remember" class="icheck pull-left" /> Nhớ đăng nhập
						</label>
